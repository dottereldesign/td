...
export const TOWER_DEFINITIONS: Record<TowerId, TowerDefinition> = {
  sentry: {
    ...
    description: 'Balanced fire. Excels against Medium armor.',
    cost: 90,
    damage: 24,
    interval: 0.82,
    range: 2.7,
  ...
  needle: {
    ...
    attackType: 'pierce',
    role: 'Pierce · Rapid',
    description: 'Fast precision fire. Shreds Light and Unarmored.',
    cost: 120,
    damage: 13,
    interval: 0.38,
    range: 3.15,
  ...
  mortar: {
    ...
    attackType: 'siege',
    role: 'Siege · Splash',
    description: 'Slow area damage. Built to crack Fortified armor.',
    cost: 175,
    damage: 58,
    interval: 1.7,
    range: 3.45,
  ...
  toxin: {
    ...
    attackType: 'pierce',
    role: 'Pierce · Poison',
    description: 'Applies stacking poison from up to three posts.',
    cost: 145,
    damage: 8,
    interval: 0.75,
    range: 2.85,
...
export const LEVELS: LevelDefinition[] = [
  ...
  },
  {
    ...
    number: '03',
    name: 'Gauntlet',
    subtitle: 'Short route / severe',
    briefing: 'A compact route with fewer seconds to correct mistakes. Sell and rebuild around the wave forecast.',
    cols: 18,
    rows: 11,
    startCash: 470,
    startLives: 15,
